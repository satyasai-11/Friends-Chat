	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session==null){
			...
			try{
				...
				PreparedStatement ps=con.prepareStatement("select * from frndschat_message where receiver=? OR sender=? and trash=? order by id desc");
				...
				while(rs.next()){
					out.print("<tr><td>"+rs.getString("sender")+"</td><td><a href= 'ViewServlet2?id="+rs.getString(1)+"'>"+rs.getString("subject")+"</td></tr>");
